...
//         <div className="row" id="registration_main">
//           <div className="row registration_header">
//             <div
...
//           <div className="row" id="buyerVendor_register">
//             <div
//               className="col-xs-12 col-md-6 become_container"
//               id="becomeBuyer_container"
//             >
