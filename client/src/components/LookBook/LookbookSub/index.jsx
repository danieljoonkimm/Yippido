...
import './lookbooksub.scss';


class LookbookSub extends Component {
  constructor(props) {
    super(props);
  ...
  _onCollapse (e) {
    const collapsible = document.getElementById(`lookbook__sub__view__all`);
    let wrapper = document.querySelector(`.lookbook__sub__view__all__wrapper`);

    collapsible.style.height === 0 ?  collapsible.style.height = `${wrapper.clientHeight}px` : null;
  ...
  render() {
    ...
    <g>
      ...
      <g transform="matrix(21.955 0 0 -21.955 126.15 202.12)">
        <path d="m0 0v2.33" stroke="#000" strokeWidth="0.587" />
      </g>
      <g transform="matrix(21.955 0 0 -21.955 -2043.1 10481)">
        <g clipPath="url(#c)">
    ...
    return (
      <div id="lookbookSub">
        <div className="container">
          <div className="lookbook__sub__item__detail row">
            <div className="col-xs-9 col-sm-9 col-md-9" style={{ padding: 0}}>
              <CarouselImages _onCollapse={this._onCollapse}/>
            </div>
            <div className="col-xs-3 col-sm-3 col-md-3">
              <div className="row" style={{ borderTop: '1px solid grey'}}>
                <h2 style={{ textAlign: 'center', padding: '10px'}}>Item Detail</h2>
                <div className="lookbooksub__details  col-xs-12 col-sm-12 col-md-12">
                  <ProductImage 
                    ...
                    isViewable={false}
                  />
                  <p>Amunzen dress with tiered ruffle sleeves pockets</p>
                  <p>F0452466/ $69.00</p>
          ...
          <div id="lookbook__sub__view__all" className="grow" style={{ height: 0 }}>
            <div className="lookbook__sub__view__all__wrapper">
              <div className="lookbook__sub__item__detail row">
                <div className="col-xs-9 col-sm-9 col-md-9" style={{ padding: 0}}>
                  <CarouselImages/>
                </div>
            ...
            <div className="row">
              ...
              <div className="col-xs-7 col-sm-7 col-md-7">
                <div className="row" style={{ backgroundColor: '#fff', borderRadius: '8px', display: 'flex' }}>
                  <div className="col-xs-7 col-sm-7 col-md-7">
                    <img src={this.images[0][0].url} alt="" className="" style={{ display: 'flex' }} />
                  </div>
                  <div className="col-xs-5 col-sm-5 col-md-5" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                    <div className="row" style={{ display: 'flex' }}>
                      <div className="col-xs-12 col-sm-12 col-md-12" >
                        <img src={this.images[0][1].url} alt="" className="" style={{ padding: '30px 20px' }} />
